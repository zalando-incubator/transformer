...
- how to use Transformer as a **Python library**.
...
.. toctree::
   ...
   🌱 Create a HAR file <Creating-HAR-files>
   ⚖ Decide how much a scenario is run compared to others <Specifying-weights>
   👑 Organize your scenarios in a hierarchy <Hierarchical-scenarios>
   🙈🙉 Ignore specific URLs <Ignoring-urls>
   🔌 Use plugins <Using-plugins>
   🚀 Write plugins <Writing-plugins>
   🏅 Contribute to Transformer <Contributing>
